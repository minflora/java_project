...
public class ProductDAO {
	...
	public String pageNumber(int tpage, String name) {
		...
		if (start_page > view_rows) {
			str += "<a href='SpiritaServlet?command=product_list&tpage=1&key=" 
					+ name + "'>&lt;&lt;</a>&nbsp;&nbsp;";
			str+="<a href='SpiritaServlet?command=product_list&tpage=" 
					+ (start_page - 1);
	...
	public String adminPageNumber(int tpage, String name) {
	    String str = "";
	    ...
	    if (start_page > view_rows) {
	      str += "<a href='SpiritaServlet?command=admin_product_list&tpage=1&key=" 
	         + name + "'>&lt;&lt;</a>&nbsp;&nbsp;";
	      str+="<a href='SpiritaServlet?command=admin_product_list&tpage=" 
	         + (start_page - 1);
	      str += "&key=<%=product_name%>'>&lt;</a>&nbsp;&nbsp;";
	    }
	...
	public ArrayList<ProductVO> listProduct(int tpage, String product_name) {
		...
		String str = "select pseq, indate, name, price " +
	...
	public int insertProduct(ProductVO product) {
		...
		String sql = "insert into product (" +
				"pseq, kind, name, price, content, image) " +
	...
	public int updateProduct(ProductVO product) {
		int result = -1;
		String sql = "update product set kind=?, name=?" +
				", price=?, content=?, image=? " +
				"where pseq=?";
		...
		try {
			...
			pstmt.setString(4, product.getContent());
			pstmt.setString(5, product.getImage());
			pstmt.setInt(6, product.getPseq());
			result = pstmt.executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
