...
<script type="text/javascript">
  function go_order_save() {
    ...
    if (count == 0) {
      ...
      document.frm.action = "SpiritaServlet?command=admin_order_save";
      document.frm.submit();
    }
  }
</script>
...
<form name="frm" method="post">
  <table style="float: right;">
    <tr>
      ...
      <input class="btn" type="button" value="검색" onclick="go_search_order_name()">
      </td>
    </tr>
  </table>
  <br>
  ...
  <tr>
    ...
    <td>${orderVO.quantity}</td> <td>${orderVO.zipcode}</td>
